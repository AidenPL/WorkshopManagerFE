        ...
        return (
            ...
            <div>
                ...
                >
                    ...
                    <form class="form-inline my-2 my-md-0" onSubmit={this.postJob}>
                    <input class="form-control" type="text" id='commenttxt' placeholder="Comment" onChange={this.handleChange}/>
